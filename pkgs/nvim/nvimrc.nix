...
" Vim System
    ...
    hi Error cterm=reverse ctermfg=white ctermbg=black
    hi Search ctermfg=lightyellow ctermbg=blue
    hi IncSearch ctermfg=lightyellow ctermbg=blue
...
" Language Syntax
    ...
    hi MatchParen ctermfg=lightyellow ctermbg=blue
